...
public class TableDRLCaNhan extends TableCo5Cot {

    public TableDRLCaNhan() {
        ...
        private void setColumnWidths() {
            ...
            // Tính tổng tỷ lệ
            double totalWeight = 1.0 / 10 + 2.0 / 10 + 2.0 / 10 + 1.0 / 10 + 4.0 / 10;

            // Thiết lập độ rộng của từng cột theo tỷ lệ
            TableColumn column;
            column = columnModel.getColumn(0);
            column.setPreferredWidth((int) (getWidth() * (1.5 / totalWeight))); // Cột 1
            column = columnModel.getColumn(1);
            column.setPreferredWidth((int) (getWidth() * (2.0 / totalWeight))); // Cột 2
            column = columnModel.getColumn(2);
            column.setPreferredWidth((int) (getWidth() * (3.0 / totalWeight))); // Cột 3
            column = columnModel.getColumn(3);
            column.setPreferredWidth((int) (getWidth() * (0.75 / totalWeight))); // Cột 4
            column = columnModel.getColumn(4);
            column.setPreferredWidth((int) (getWidth() * (0.75 / totalWeight))); // Cột 5
