...
public class TableChamDiem extends Table {

    public TableChamDiem() {
    ...
    private void setColumnWidths() {
        ...
        column.setPreferredWidth((int) (getWidth() * (0.5 / totalWeight))); // Cột 1
        column = columnModel.getColumn(1);
        column.setPreferredWidth((int) (getWidth() * (7.5 / totalWeight))); // Cột 2
        column = columnModel.getColumn(2);
        column.setPreferredWidth((int) (getWidth() * (1.0 / totalWeight))); // Cột 3
