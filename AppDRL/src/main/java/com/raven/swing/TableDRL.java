...
public class TableDRL extends TableCo5Cot {
    ...
    public TableDRL() {
        ...
        private void setColumnWidths() {
            ...
            column.setPreferredWidth((int) (getWidth() * (1.0 / totalWeight))); // Cột 4
            column = columnModel.getColumn(4);
            column.setPreferredWidth((int) (getWidth() * (1.0 / totalWeight))); // Cột 5
