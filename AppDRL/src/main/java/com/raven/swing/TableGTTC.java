...
public class TableGTTC extends Table {
    ...
    private void setColumnWidths() {
        ...
        column.setPreferredWidth((int) (getWidth() * (9.0 / totalWeight))); // Cột 1
        column = columnModel.getColumn(1);
        column.setPreferredWidth((int) (getWidth() * (1.0 / totalWeight))); // Cột 2
