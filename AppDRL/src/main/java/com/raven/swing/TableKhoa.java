...
public class TableKhoa extends TableCo5Cot {
    ...
    public TableKhoa() {
        ...
        private void setColumnWidths() {
            ...
            column.setPreferredWidth((int) (getWidth() * (5.0 / totalWeight))); // Cột 2
            ...
            column.setPreferredWidth((int) (getWidth() * (2.5 / totalWeight))); // Cột 5
        }
