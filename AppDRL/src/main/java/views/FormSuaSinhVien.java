 ...
 * @author Dat
 */
public final class FormSuaSinhVien extends javax.swing.JFrame {
    ...
    public FormSuaSinhVien(ArrayList<SinhVien> dsSV, SinhVien sv, ArrayList<JLabel> dsLabel) throws ParseException {
        //this.khoa = dsKhoa.get(chon);
        initComponents();
        setLocationRelativeTo(null);
        this.dsSV = dsSV;
            ...
            if(JOptionPane.showConfirmDialog(rootPane, "Bạn có chắc chắn thay đổi không?") == JOptionPane.YES_OPTION){
                for(SinhVien s: dsSV){
                    if(s.getMaSV().equals(sv.getMaSV())){
                        s.setHoTen(ThuatToan.chuanHoaDiaDanh(jTextFieldTenCoVan.getText()));
                ...
                dsLabel.get(0).setText(sv.getHoTen());
                dsLabel.get(1).setText(sv.getSdt());
                dsLabel.get(2).setText(ThuatToan.doiBoolToGioiTinh(Boolean.toString(sv.isGioiTinh())));
                dsLabel.get(3).setText(ThuatToan.doiNgay(sv.getNgaySinh()));
                dsLabel.get(4).setText(sv.getQueQuan());
                dsLabel.get(5).setText(sv.getDiaChi());
                new Thread(() -> {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSuaSinhVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FormSuaSinhVien().setVisible(true);
        });
    }
